  ...
  dev: {
    ...
    Functions: {
      ...
      drop_function_if_exists: {
        Args: { function_name: string; function_args: string[] }
        Returns: undefined
      }
      drop_temp_tables: {
        Args: { p_suffix: string }
      ...
      insert_temp_followers: {
        Args: { p_followers: Json; p_account_id: string; p_suffix: string }
        Returns: undefined
      }
      insert_temp_following: {
        Args: { p_following: Json; p_account_id: string; p_suffix: string }
        Returns: undefined
      }
      insert_temp_likes: {
        Args: { p_likes: Json; p_account_id: string; p_suffix: string }
        Returns: undefined
      }
      insert_temp_profiles: {
        Args: { p_profile: Json; p_account_id: string; p_suffix: string }
        Returns: undefined
      }
      insert_temp_tweets: {
        Args: { p_tweets: Json; p_suffix: string }
        Returns: undefined
      }
  ...
  public: {
    ...
    Functions: {
      ...
      get_account_most_liked_tweets_archive_users: {
        Args: { username_: string; limit_?: number }
        Returns: {
          tweet_id: string
          account_id: string
          created_at: string
      ...
      get_scraper_counts_by_granularity: {
        Args: { start_date: string; end_date: string; granularity: string }
        Returns: {
          scraper_date: string
