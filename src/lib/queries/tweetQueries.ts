 ...
 *
 * PostgreSQL FTS drops English stop words ("you", "can", "do", "the", …),
 ...
 * It cannot use the GIN index, but the result set for a specific multi-word
 * phrase is typically very small, and the btree index on created_at keeps
 * the sort fast once Postgres has filtered.
 */
