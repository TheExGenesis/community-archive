-- Give structured-output providers room to finish subtitles instead of
-- satisfying a tight maxLength by clipping the sentence at 149 characters.
insert into "public"."digest_prompt_versions" (
  ...
  'Complete explanatory subtitles high-judgment digest',
