-- Preserve the lab's community-specific editorial weighting while carrying
-- forward the complete-subtitle instructions as another immutable version.
insert into "public"."digest_prompt_versions" (
  ...
  'Complete explanatory subtitles community-weighted digest',
