...
CREATE TABLE IF NOT EXISTS "public"."conversations" (
    ...
    "producer_source" "text" NOT NULL DEFAULT 'legacy',
    "resolution_status" "text" NOT NULL DEFAULT 'legacy',
...
-- Bounded resolver telemetry, historical reconciliation state, and the
-- aggregate monitoring snapshot. PostgreSQL owns this serving metadata;
-- producer payloads only supply authoritative conversation IDs.
CREATE TABLE IF NOT EXISTS "public"."conversation_resolution_runs" (
...
ALTER TABLE "public"."conversation_resolution_runs" OWNER TO "postgres";
...
ALTER TABLE "public"."conversation_resolution_reconciliation" OWNER TO "postgres";
...
ALTER TABLE "public"."conversation_resolution_coverage_snapshots" OWNER TO "postgres";
