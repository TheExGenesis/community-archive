...
--
-- Supabase preview branches intentionally load only seed.sql: the branching
-- seeder rejects the database payload produced by this 100,000-row fixture.
-- Staging bootstrap/sync scripts apply this file separately, and production
-- deployment ignores seed files.
